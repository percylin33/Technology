    ...
    return (
        <div className='shadow-md w-full fixed top-0 left-0'>
            <div className='md:flex bg-negro items-center justify-between  bg-white py-4 md:px-10 px-7'>
                ...
                <ul className={`bg-negro md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-[75px] opacity-100':'top-[-490px] md:opacity-100 opacity-0'} `}>
                    {linkNav.map((li) => (
